        ...
        for feature in features:
            ...
            if any(param.get("value") == target_value for param in parameters):
                ...
                for param in parameters:
                    if param.get("parameterId") == "lengthValue":
...
# Example usage
parameters_with_c1 = extract_parameters_with_value('output.json', target_value="C1")
print(parameters_with_c1)  # Prints the extracted parameters containing "value": "C1"
...
def return_payload_feature1_dict(id, value):
    payload1 = {"btType": "BTFeatureDefinitionCall-1406",
          ...
          "name" : "###name = #value",
          "parameters" : extract_parameters_with_value('output.json', target_value="C1", value=value)}}
...
def return_payload_feature2_dict(id, value):
    payload2 = {"btType": "BTFeatureDefinitionCall-1406",
          ...
          "featureType": "assignVariable",
          "name" : "###name = #value",
          "parameters" : extract_parameters_with_value('output.json', target_value="C2", value=value)}}
...
def return_payload_feature3_dict(id, value):
    payload3 = {"btType": "BTFeatureDefinitionCall-1406",
          ...
          "featureType": "assignVariable",
          "name" : "###name = #value",
          "parameters" : extract_parameters_with_value('output.json', target_value="C3", value=value)}}
...
def return_payload_feature4_dict(id, value):
    payload4 = {"btType": "BTFeatureDefinitionCall-1406",
          ...
          "featureType": "assignVariable",
          "name" : "###name = #value",
          "parameters" : extract_parameters_with_value('output.json', target_value="C4", value=value)}}
